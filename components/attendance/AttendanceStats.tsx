    ...
    <Card className="stats-card hover:shadow-lg transition-all duration-300">
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          ...
          <div className={`p-3 rounded-full ${bgColor} transition-colors duration-300`}>
            <div className={color}>
              {icon}
            </div>
          </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <div className="text-center">
              ...
              <Badge variant="outline" className="mt-1 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800">
            ...
            <div className="text-center">
              ...
              <Badge variant="outline" className="mt-1 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-800">
            ...
            <div className="text-center">
              ...
              <Badge variant="outline" className="mt-1 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-400 border-yellow-200 dark:border-yellow-800">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{stats.workFromHome}</div>
              <div className="text-sm text-muted-foreground">WFH</div>
              <Badge variant="outline" className="mt-1 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800">
            ...
            <div className="text-center">
              ...
              <Badge variant="outline" className="mt-1 bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 border-orange-200 dark:border-orange-800">
